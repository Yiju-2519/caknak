...
import { AlertTriangle, CheckCircle2, CheckCircle, XCircle, Link } from "lucide-react";
        ...
        >
            ...
            {!result ? (
                <div className="flex flex-col items-center justify-center flex-grow text-center p-6">
                    ...
                    <p className="text-[#ffffc5] max-w-lg mb-6">
                        ...
                        <div className="bg-[#f9f4e6] border-4 border-[#5b4636] rounded-lg shadow-lg p-6 flex flex-col h-full min-h-[600px] justify-between">
                            ...
                            {activeTab === "Email Content" && (
                                <motion.button
                                    ...
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full px-8 py-3 mt-4 rounded-xl bg-[#ffc067] bg-cover font-bold text-xl text-[#5b4636] border-4 border-[#5b4636] disabled:opacity-60"
                                    ...
                                    <div className="mb-0.1">
                                        ...
                                        <div className="bg-white/80 border-2 border-[#b6b6b6] rounded-lg p-4 flex flex-col md:flex-row md:items-center md:justify-between">
                                            <div>
                                                ...
                                                <div className="text-[#5b4636] text-sm"> Improve protective knowledge with our comprehensive resources</div>
                                            </div>
                                            <a href="/educate/phishing-prevention" className="mt-3 md:mt-0 px-5 py-2 bg-[#4F959D] text-white rounded-lg font-semibold shadow hover:bg-[#a68a64] hover:scale-105 transition">
